...
public class AssetSetter {
  ...
  private static final int MAIN_MAP_NPC_NUMBER = 10;
  private static final int MAIN_MAP_MONSTER_NUMBER = 20;
  private static final int INTERIOR_MAP_NPC_NUMBER = 5;
  ...
  public void setInteractiveTiles() {
    ...
    int i = 0;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 27, 12);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 28, 12);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 29, 12);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 30, 12);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 31, 12);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 32, 12);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 33, 12);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 18, 40);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 17, 40);
    i++;
    gamePanel.mapsInteractiveTiles.get(MAIN_MAP)[i] = new DryTreeInteractive(gamePanel, 16, 40);
  }
}
